        ...
        <Container>
          ...
          <div className="relative z-10">
            <div className="max-w-full text-center">
              <p className="max-w-full text-medium leading-7 text-black/55 md:text-base">
                ...
                <div className="grid flex-1 border-l border-t border-black/20 md:grid-cols-2">
                  {principles.map((item, index) => (
                    ...
                    >
                      ...
                      <p className="relative mt-5 max-w-md text-medium leading-7 text-black/45 transition-colors duration-500 group-hover:text-white/45">
                        {item.text}
                      </p>
