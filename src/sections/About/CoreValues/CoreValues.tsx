      ...
      <Container>
        <div className="relative z-10">
          ...
          <div className="w-full">
            ...
            >
              <p className="space-y-6 text-sm leading-8 text-black/55 md:text-base text-center">
          ...
          {/* Values */}
          <div className="mt-10 grid border-l border-t border-black/10 md:grid-cols-2">
            {values.map((value, index) => (
              ...
              >
                ...
                {/* Description */}
                <p className="relative mt-5 max-w-md text-sm leading-7 text-black/50 transition-colors duration-500 group-hover:text-white/45">
                  {value.description}
                </p>
