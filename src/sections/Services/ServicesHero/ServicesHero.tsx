      ...
      <Container>
        <div className="relative mt-20 z-10 flex  flex-col justify-center">
          ...
          >
            Our 
            <br />
            <span className="text-[#F5C400]">Services</span>
          </motion.h1>
          ...
          >
            <p className="text-sm leading-7 text-black/55 md:text-base">
                Explore the construction services provided by Axis & Grids,
                from residential and commercial construction to civil works,
                renovation, supervision and project procurement.
            </p>
          </motion.div>
        ...
        <div className="absolute z-10 left-160 right-0 -top-30 h-full w-full  pt-28 lg:pt-52">
